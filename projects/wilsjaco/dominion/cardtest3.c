...
* Description: Unit test for the Village card. The program
...
int main() {
	...
	testGame.hand[currentPlayer][handPos] = village;
	...
	// TEST that player gained two actions
	printf("Player should gain two actions:\n");
