...
//Adventurer refactored
int adventurer2(int currentPlayer, struct gameState *state, int handPos)
{
  int cardDrawn;
...
//cutpurse refactored
int cutPurse2(int currentPlayer, struct gameState *state, int handPos)
{
  int i;
  int k;
  int j;
...
//village refactored
int village2(int currentPlayer, struct gameState *state, int handPos)
{
  //+1 Card
      drawCard(currentPlayer, state);
...
//great_hall refactored
int great_hall2(int currentPlayer, struct gameState *state, int handPos)
{
  //+1 Card
     drawCard(currentPlayer, state);
...
//smithy refactored
int smithy2(int currentPlayer, struct gameState *state, int handPos)
{
  int i;
  //+3 Cards
  for (i = 0; i < 4; i++)
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurer2(currentPlayer, state, handPos);
      return 0;
  ...
  //     return 0;
    ...
    case smithy:
      smithy2(currentPlayer, state, handPos);
      return 0;
  //     //+3 Cards
  //     for (i = 0; i < 3; i++)
	// {
  ...
  //
     case village:
     village2(currentPlayer, state, handPos);
  //     //+1 Card
  //     drawCard(currentPlayer, state);
  //
  //     //+2 Actions
  ...
  //     return 0;
    ...
    case great_hall:
      great_hall2(currentPlayer, state, handPos);
      return 0;
      // //+1 Card
      // drawCard(currentPlayer, state);
      //
    ...
    case cutpurse:
      cutPurse2(currentPlayer, state, handPos);
      return 0;
  //     updateCoins(currentPlayer, state, 2);
  //     for (i = 0; i < state->numPlayers; i++)
	// {
